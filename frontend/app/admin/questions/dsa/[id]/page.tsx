    ...
    <div className="lg:col-span-7">
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900 overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          {question.codeInAllLangs.map((lang) => (
            <div
              key={lang.lang}
              className="border border-zinc-800 rounded-xl overflow-hidden"
            >

              <div className="bg-zinc-950 border-b border-zinc-800 px-4 py-3 font-medium">
                {lang.lang}
              </div>
              ...
              <div className="p-4">
                ...
                <div className="mb-5">
                  ...
                  <pre className="bg-black text-sm p-4 rounded-xl overflow-auto no-scrollbar max-h-[400px]">
                    {lang.starterCode}
                  </pre>
          ...
          <div className="border border-green-900 rounded-xl overflow-hidden">
            ...
            <pre className="bg-black text-sm p-4 overflow-auto no-scrollbar max-h-[500px]">
